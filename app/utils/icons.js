...
export const board = <i class="fa-regular fa-square"></i>
export const settings = <i class="fa-solid fa-gear"></i>
export const teams = <i class="fa-solid fa-people-group"></i>
export const analytics = <i class="fa-solid fa-chart-line"></i>
export const notification = <i class="fa-regular fa-bell"></i>
export const mode = <i class="fa-regular fa-sun"></i>
export const arrow = <i class="fas fa-angle-double-right"></i>